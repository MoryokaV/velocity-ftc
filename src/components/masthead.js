  ...
  return (
    <>
      ...
      >
        ...
        />
        <div
          className={`transition-all text-white text-center absolute top-1/4 left-1/2 -translate-x-1/2 opacity-0 duration-700 ${
            headingAnimation && "opacity-100 translate-y-24"
          }`}
        >
          <h1 className="text-7xl mb-4 tracking-tighter drop-shadow-sm">
            Velocity
          </h1>
          <h2 className="text-3xl tracking-tight drop-shadow-sm">
            {AboutData.subtitle}
          </h2>
        </div>
      </div>
